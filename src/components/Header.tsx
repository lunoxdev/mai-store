            ...
            <div className="flex justify-end md:w-1/3">
                ...
                <div className="relative cursor-pointer" onClick={openCart}>
                    ...
                    <svg
                        ...
                        height="28"
                        viewBox="0 0 256 256"
                        className="h-8 w-8 sm:h-12 sm:w-12 cursor-pointer transition duration-200 ease-in-out hover:scale-110"
                    >
                        <path
                            fill="#ffffff"
                    ...
                    {cartCount > 0 && (
                        <span className="absolute -top-0 -right-1.5 bg-blue-600 text-xs sm:text-sm font-bold rounded-full h-5 w-5 flex items-center justify-center">
                            {cartCount}
                        </span>
                    )}
                </div>
